...
test.describe('Load More Functionality Tests', () => {
  ...
  test('Experience Load More button should be visible and functional', async ({
    page,
  }) => {
    ...
    const initialVisibleCount = await page
      .locator('.work-item:not(.project-item):visible')
      .count();
    console.log(
      `Initial experience items: ${initialVisibleCount} visible of ${totalCount} total`
    );
    ...
    if (totalCount > initialVisibleCount) {
      ...
      const newVisibleCount = await page
        .locator('.work-item:not(.project-item):visible')
        .count();
      expect(newVisibleCount).toBeGreaterThan(initialVisibleCount);
      console.log(
        `After Load More: ${newVisibleCount} items visible (was ${initialVisibleCount})`
      );
    } else {
      console.log(
        'No Load More button needed - all experience items fit initially'
      );
    }
  });

  test('Projects Load More button should be visible and functional', async ({
    page,
  }) => {
    ...
    console.log(
      `Initially visible projects: ${visibleInitialProjects} of ${initialCount}`
    );
  ...
  test('Education Load More button should be visible and functional', async ({
    page,
  }) => {
  ...
  test('Skills Load More button should be visible and functional', async ({
    page,
  }) => {
    ...
    console.log(
      `Initially visible skills: ${visibleInitialSkills} of ${initialCount}`
    );
  ...
  test('JavaScript pagination functions should be defined and working', async ({
    page,
  }) => {
    ...
    const functionsExist = await page.evaluate(() => {
      return {
        initializeExperiencePagination:
          typeof initializeExperiencePagination !== 'undefined',
        initializeProjectsPagination:
          typeof initializeProjectsPagination !== 'undefined',
        initializeEducationPagination:
          typeof initializeEducationPagination !== 'undefined',
        initializeSkillsPagination:
          typeof initializeSkillsPagination !== 'undefined',
      };
    });
  ...
  test('Load More buttons should have proper ARIA labels and accessibility', async ({
    page,
  }) => {
  ...
  test('Emergency failsafe: Content should be visible even if JavaScript fails', async ({
    page,
  }) => {
    // Disable JavaScript
    ...
    console.log(
      `With JS error - Work items: ${workCount}, Projects: ${projectCount}, Education: ${educationCount}`
    );
