...
test.describe('Real Print Behavior Tests', () => {
  ...
  test('Real browser print preview matches content visibility', async ({ page }) => {
    ...
    console.log('✅ Real print test completed - screenshot saved to test-results/real-print-preview.png');
  });
