...
test.describe('Layout Analysis & Usability Tests', () => {
  test('Desktop - Generate screenshot and analyze layout issues', async ({ page }) => {
    await page.goto('/');
  ...
  test('Mobile iPhone 15 Pro Max - Generate screenshot and analyze usability', async ({ page }) => {
    await page.goto('/');
  ...
  test('Tablet iPad Pro - Generate screenshot for tablet analysis', async ({ page }) => {
    // Set tablet viewport
