...
test.describe('Mobile Layout Tests', () => {
  test('iPhone 15 Pro Max - should display resume without floating controls blocking content', async ({ page }) => {
    await page.goto('/');
  ...
  test('Mobile - content should be readable and not overlapped', async ({ page }) => {
    await page.goto('/');
