...
- **Versioned PDF**: `resume-rafael-sathler-v1.7.1pdf`
...
- **Footer**: Shows current version `v1.7.1` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.7.1">`
...
gh workflow run emergency-deploy.yml -f version=v1.7.1
```
...
gh release create v1.7.1 --notes "Emergency hotfix release"
