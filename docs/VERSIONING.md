...
- **Git Tag**: `v2.2.2.2.2.0`
- **GitHub Release**: With auto-generated changelog
- **Versioned PDF**: `resume-rafael-sathler-v2.2.2.2.2.0pdf`
...
- **Footer**: Shows current version `v2.2.2.2.2.0` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="2.2.2.2.0">`
...
gh workflow run emergency-deploy.yml -f version=v2.2.2.2.2.0
```
...
gh release create v2.2.2.2.2.0 --notes "Emergency hotfix release"
...
# Check for conflicts
git tag --list | grep v2.2.2.2.2.0
```
...
gh release create v2.2.2.2.2.0 --generate-notes
```
...
gh release create v2.2.2.2.2.0 \
  --title "Release v2.2.2.2.2.0" \
