...
- **Versioned PDF**: `resume-rafael-sathler-v1.18.2pdf`
...
- **Footer**: Shows current version `v1.18.2` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.18.2">`
...
gh workflow run emergency-deploy.yml -f version=v1.18.2
```
...
gh release create v1.18.2 --notes "Emergency hotfix release"
...
gh release create v1.18.2 --generate-notes
```
...
gh release create v1.18.2 \
  --title "Release v1.18.2" \
