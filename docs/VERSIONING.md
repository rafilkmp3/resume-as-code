...
- **Versioned PDF**: `resume-rafael-sathler-v2.2.2.1.1pdf`
...
- **Footer**: Shows current version `v2.2.2.1.1` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="2.2.1.1">`
...
gh workflow run emergency-deploy.yml -f version=v2.2.2.1.1
```
...
gh release create v2.2.2.1.1 --notes "Emergency hotfix release"
...
gh release create v2.2.2.1.1 --generate-notes
```
...
gh release create v2.2.2.1.1 \
  --title "Release v2.2.2.1.1" \
