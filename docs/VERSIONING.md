...
- **Versioned PDF**: `resume-rafael-sathler-v1.19.3pdf`
...
- **Footer**: Shows current version `v1.19.3` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.19.3">`
...
gh workflow run emergency-deploy.yml -f version=v1.19.3
```
...
gh release create v1.19.3 --notes "Emergency hotfix release"
...
gh release create v1.19.3 --generate-notes
```
...
gh release create v1.19.3 \
  --title "Release v1.19.3" \
