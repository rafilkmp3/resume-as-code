...
- **Versioned PDF**: `resume-rafael-sathler-v1.7.0pdf`
...
- **Footer**: Shows current version `v1.7.0` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.7.0">`
...
gh workflow run emergency-deploy.yml -f version=v1.7.0
```
...
gh release create v1.7.0 --notes "Emergency hotfix release"
