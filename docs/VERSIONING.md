...
- **Versioned PDF**: `resume-rafael-sathler-v1.17.4pdf`
...
- **Footer**: Shows current version `v1.17.4` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.17.4">`
...
gh workflow run emergency-deploy.yml -f version=v1.17.4
```
...
gh release create v1.17.4 --notes "Emergency hotfix release"
...
gh release create v1.17.4 --generate-notes
```
...
gh release create v1.17.4 \
  --title "Release v1.17.4" \
