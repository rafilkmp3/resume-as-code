...
- **Versioned PDF**: `resume-rafael-sathler-v2.2.1.0pdf`
...
- **Footer**: Shows current version `v2.2.1.0` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="2.1.0">`
...
gh workflow run emergency-deploy.yml -f version=v2.2.1.0
```
...
gh release create v2.2.1.0 --notes "Emergency hotfix release"
...
gh release create v2.2.1.0 --generate-notes
```
...
gh release create v2.2.1.0 \
  --title "Release v2.2.1.0" \
