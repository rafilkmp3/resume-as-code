...
- **Versioned PDF**: `resume-rafael-sathler-v1.11.0pdf`
...
- **Footer**: Shows current version `v1.11.0` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.11.0">`
...
gh workflow run emergency-deploy.yml -f version=v1.11.0
```
...
gh release create v1.11.0 --notes "Emergency hotfix release"
...
gh release create v1.11.0 --generate-notes
```
