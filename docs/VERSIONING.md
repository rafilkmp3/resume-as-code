...
- **Versioned PDF**: `resume-rafael-sathler-v1.7.2pdf`
...
- **Footer**: Shows current version `v1.7.2` with link to GitHub release
- **Meta tags**: `<meta name="app-version" content="1.7.2">`
...
gh workflow run emergency-deploy.yml -f version=v1.7.2
```
...
gh release create v1.7.2 --notes "Emergency hotfix release"
...
gh release create v1.7.2 --generate-notes
```
